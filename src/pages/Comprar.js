...
const StandsListing = () => {
    ...
    const stands = [
        {
            ...
            category: "stands.categories.clothing",
            rating: 4.8,
            reviews: 234,
            priceRange: "$",
            image: "/maca.jpg",
            ...
            tags: ["stands.tags.coffee", "stands.tags.breakfast", "stands.tags.freeWifi"],
            trending: true,
        ...
        },
        {
            ...
            category: "stands.categories.technology",
            rating: 4.6,
            reviews: 189,
            priceRange: "$$$",
            image: "",
            ...
            tags: ["stands.tags.laptops", "stands.tags.accessories", "stands.tags.repairs"],
            trending: false,
        ...
        },
        {
            ...
            category: "stands.categories.stationery",
            rating: 4.5,
            reviews: 156,
            priceRange: "$",
            image: "",
            ...
            tags: ["stands.tags.supplies", "stands.tags.printing", "stands.tags.photocopies"],
            trending: false,
        ...
        },
        {
            ...
            tags: ["stands.tags.universityClothing", "stands.tags.accessories", "stands.tags.discounts"],
            trending: true,
        ...
        },
        {
            ...
            university: "Universidad Javeriana",
            category: "stands.categories.books",
            rating: 4.9,
            reviews: 412,
            priceRange: "$$",
            image: "",
            ...
            tags: ["stands.tags.academicBooks", "stands.tags.literature", "stands.tags.studentDiscounts"],
            trending: false,
        ...
        },
        {
            ...
            name: "Healthy Bites",
            university: "Universidad de los Andes",
            category: "stands.categories.food",
            rating: 4.4,
            reviews: 178,
            priceRange: "$$$",
            image: "",
            ...
            tags: ["stands.tags.healthyFood", "stands.tags.vegan", "stands.tags.glutenFree"],
            trending: true,
    ...
    const categories = [
        { key: "todos", messageId: "stands.categories.all" },
        { key: "stands.categories.food", messageId: "stands.categories.food" },
        { key: "stands.categories.technology", messageId: "stands.categories.technology" },
        { key: "stands.categories.stationery", messageId: "stands.categories.stationery" },
        { key: "stands.categories.clothing", messageId: "stands.categories.clothing" },
        { key: "stands.categories.books", messageId: "stands.categories.books" }
    ];
    ...
    const filteredStands = stands.filter(stand => {
        ...
        const matchesSearch = stand.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
                            stand.tags.some(tag => {
                                const tagTranslation = intl.formatMessage({ id: tag });
                                return tagTranslation.toLowerCase().includes(searchQuery.toLowerCase());
                            });
                ...
                <div className="search-header">
                    <div className="header-content">
                        <h1 className="page-title">
                            <FormattedMessage id="stands.title" />
                        </h1>
                        ...
                        <div className="search-container">
                            ...
                            <input
                                type="text"
                                placeholder={intl.formatMessage({ id: "stands.searchPlaceholder" })}
                ...
                <div className="filters-section">
                    <div className="filters-container">
                        <button className="filter-button">
                            ...
                            <span>
                                <FormattedMessage id="stands.filters" />
                            </span>
                        </button>
                        ...
                        >
                            <option value="todas">
                                {intl.formatMessage({ id: "stands.allUniversities" })}
                            </option>
                        ...
                        >
                            {categories.map(cat => (
                                <option key={cat.key} value={cat.key}>
                                    {intl.formatMessage({ id: cat.messageId })}
                                </option>
                            ))}
                        </select>
                        ...
                        >
                            <option value="rating">
                                {intl.formatMessage({ id: "stands.sortByRating" })}
                            </option>
                            <option value="reviews">
                                {intl.formatMessage({ id: "stands.sortByReviews" })}
                            </option>
                            <option value="distance">
                                {intl.formatMessage({ id: "stands.sortByDistance" })}
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div className="results-container">
                    <Link to="/anuncio-stand" className="results-link">
                        <p className="results-count">
                            <FormattedMessage 
                                id="stands.resultsCount" 
                                values={{ count: sortedStands.length }}
                            />
                        </p>
                                    ...
                                    <div className="stand-image-container">
                                        ...
                                        {stand.trending && (
                                            <div className="trending-badge">
                                                ...
                                                <FormattedMessage id="stands.trending" />
                                            </div>
                                        )}
                                        <button 
                                    ...
                                    <div className="stand-content">
                                        ...
                                        <div className="rating-container">
                                            ...
                                            <span className="reviews-count">
                                                (<FormattedMessage 
                                                    id="stands.reviewsCount" 
                                                    values={{ count: stand.reviews }}
                                                />)
                                            </span>
                                        </div>
                                        ...
                                        <div className="meta-info">
                                            <p>
                                                <FormattedMessage id={stand.category} /> • {stand.university}
                                            </p>
                                        </div>
